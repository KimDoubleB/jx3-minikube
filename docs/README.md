...
<table class="table">
  ...
  <tbody>
    ...
    <tr>
	    ...
	    <tr>
	      <td><a href='' title='A Helm chart for Kubernetes'> <img src='https://raw.githubusercontent.com/cdfoundation/artwork/master/jenkinsx/icon/color/jenkinsx-icon-color.png' width='24px' height='24px'> node-http-app </a></td>
	      <td>0.0.1</td>
	      <td><a href='http://node-http-app-jx-staging.192.168.64.7.nip.io'>view</a></td>
	      <td></td>
	    </tr>
